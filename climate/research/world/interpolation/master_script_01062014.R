...
source(file.path(script_path2,"GAM_fusion_function_multisampling_01062014.R")) #Includes Fusion and CAI methods
...
out_path <- args[8] #"/nobackup/aguzman4/climateLayers/output/"
